...
export const LaserFlow: React.FC<Props> = ({
  ...
  useEffect(() => {
    ...
    if (!mount) {
      console.warn('LaserFlow: mountRef not ready');
      return;
    }
    ...
    // Always keep inViewRef true - no IntersectionObserver needed
    // The component visibility is controlled by CSS opacity in the parent
